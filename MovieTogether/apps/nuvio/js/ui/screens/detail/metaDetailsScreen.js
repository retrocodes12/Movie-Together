...
export const MetaDetailsScreen = {
    ...
    return `
      <section class="detail-hero-section">
        ...
        <div class="series-detail-actions">
          ...
          <button class="series-primary-btn focusable watch-together-detail-btn" data-action="watchTogetherDefault">
            <span>${escapeHtml("Watch Together")}</span>
          </button>
  ...
  async completePendingHeroHold(node) {
    ...
    if (action === "watchTogetherDefault") {
      await this.playDefaultFromHero();
      return true;
    }
